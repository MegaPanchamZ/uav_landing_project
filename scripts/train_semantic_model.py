...
class Trainer:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        wandb.init(
            ...
            config=config,
            tags=["single-stage", "semantic-drone", config['model_type']],
            notes="Training on Semantic Drone Dataset from Cityscapes pretrained weights."
        )
    ...
    def train(self):
        ...
        for epoch in range(self.config['epochs']):
            ...
            train_loss = self._train_epoch(model, dataloaders['train'], criterion, optimizer)
